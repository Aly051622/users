            ...
            <div class="animated fadeIn">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="catename" id="catename" class="form-control">
                                                <option value="0">Type Vehicle</option>
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Make/Brand</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="vehcomp" name="vehcomp" class="form-control" placeholder="Make/Brand" required="true"></div>
                                    </div>
                                 
                                    <div class="row form-group">
    <div class="col col-md-3">
        <label for="vehreno" class="form-control-label">Plate Number</label>
    </div>
    <div class="col-12 col-md-9">
        <input 
            type="text" 
