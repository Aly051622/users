...
if(isset($_POST['submit'])) {
    ...
    $query = "UPDATE tblregusers SET Password='$hashedPassword' WHERE Email='$email' AND MobileNumber='$contactno'";
...
<body class="bg-dark">
    ...
    echo $msg;
                        ...
                        <button type="submit" name="submit" class="btn btn-danger btn-flat m-b-30 m-t-30"><i class="fa fa-refresh"> Reset</i></button>
                        </div>
